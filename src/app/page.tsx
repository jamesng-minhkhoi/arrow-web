    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <Marquee className="mt-4 py-4 inline-block w-screen bg-amber-600 text-black"> 
        <span className="inline-block mx-2 font-bold">
            <svg className="inline-block mx-2 w-7 h-7 text-gray-500 dark:text-gray-400 mb-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
